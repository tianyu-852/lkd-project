<template>
  <view class="u-countdown">
    <view v-if="showDays && (hideZeroDay || (!hideZeroDay && d != '00'))" class="u-countdown-item" :style="[itemStyle]">
    ...
    <!-- 小时 -->
    <view v-if="showHours && h !=='00'" class="u-countdown-item" :style="[itemStyle]">
    ...
    <!-- 分钟 -->
    <view v-if="showMinutes" class="u-countdown-item" :style="[itemStyle]">
      <view class="u-countdown-time" :style="{ fontSize: fontSize + 'rpx', color: color}">
        {{ i }}
      </view>
    </view>
    ...
    <!-- 秒 -->
    <view v-if="showSeconds" class="u-countdown-item" :style="[itemStyle]">
      <view class="u-countdown-time" :style="{ fontSize: fontSize + 'rpx', color: color}">
        {{ s }}
      </view>
    </view>
