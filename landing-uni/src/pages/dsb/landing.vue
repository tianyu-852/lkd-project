<template>
	<view class="content">
		...
		<image class="bg_bottom" style="margin-top: 20rpx;" src="/static/hd_5_iimage.png" mode="widthFix" ></image>
		<image class="bg_btn"  src="/static/ljrz_button@3x.png" mode="widthFix"></image>
	</view>
</template>
