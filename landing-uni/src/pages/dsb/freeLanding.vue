<template>
	<view class="content">
		<image class="bg_img" src="/static/hd_lawyer_1_iimage@3x.png" mode="widthFix" ></image>
		...
		<view class="card flex-column">
			...
			<image class="submit" @click="submit" src="/static/zc_button@3x.png" mode="widthFix"></image>
		</view>
		<image class="bg_bottom" src="/static/hd_5_iimage.png" mode="widthFix" ></image>
		<view class="mask flex-column" v-if="show" >
			<view class="flex-column" v-if="show == 'user'" @click="">
				<image style="width: 686rpx;" src="/static/zccg_image.png" mode="widthFix"></image>
					<view class="mask-btn" @click="toLink">立即前往律付云APP</view>
			</view>
			<view class="flex-column" v-else >
				<image style="width: 600rpx;" src="/static/yzc_image@3x.png" mode="widthFix"></image>
				<view class="mask-btn" @click="toLink">立即前往律付云APP</view>
			</view>
		</view>
	</view>
