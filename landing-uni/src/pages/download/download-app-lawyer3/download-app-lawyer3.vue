<template>
    ...
    <!-- <image class="qiye-img" style="width: 100%; height: 100%;" mode="widthFix" :src="appBgImg" @click="opanLawyerApp" /> -->
	</view>
</template>
          ...
          if (info.platform == 'ios') {
			...
			opanLawyerApp() {
				if (browser.versions.ios) {
					...
					window.location.href = 'jump-customerlinking://default'
				} else {
					window.location.href = 'lawkd://com.lawkd.enterprise/lawyer'
					// window.location.href = 'weixin://'
				}
			}
		}
