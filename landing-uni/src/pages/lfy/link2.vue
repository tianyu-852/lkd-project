...
<script>
	export default {
		data() {
			return {
        appBgImg: 'https://lvkuaidaimages.oss-cn-hangzhou.aliyuncs.com/lkd-file/202285-1659667948748-06C3ph.png'
			}
		},
		onLoad() {
      this.toDownloadApp();
      ...
      toDownloadApp(){
				...
				if (status.match(/MicroMessenger/i) == "micromessenger" && info.platform == 'ios') {
					...
					if (info.platform == 'ios') {
						...
						window.location.href= 'https://apps.apple.com/cn/app/id1581048858'
					} else {
