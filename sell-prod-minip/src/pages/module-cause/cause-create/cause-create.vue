<template>
  <view class="main" :style="{ paddingBottom: sysSafeAreaHeight + 65 + 10 + 'px' }">
    <u-navbar class="u-navbar" :is-back="false" :border-bottom="false" :background="{ backgroundColor: '#F5F5F5' }" title="发布订单" title-color="#030303">
    ...
    <view class="base-module contact-module">
      ...
      <view v-if="[7, 11].includes(causeSourceInfo.demand_type_id)" class="base-item">
        <view class="base-left">
  ...
  methods: {
    ...
    async publishCauseSource() {
      ...
      const param = {
        ...
        is_talk_detail: [7, 11].includes(causeSourceInfo.demand_type_id) ? 1 : 0, // 是否详谈
        // 联系人信息
