<template>
  <a-layout class="main">
    <a-layout-header class="top">
      <span class="focus-text">法务管家总数：{{ pagination.total }}</span>

      <a-button type="primary" style="margin: 0 10px" @click="openAddLawManagerModal">新增法务管家</a-button>
    </a-layout-header>
...
export default {
  ...
  data() {
    return {
      ...
      lawManagerSelectList: [{ label: '客服端', value: 4 } ], // 法务管家 select
  ...
  methods: {
     ...
     */
     async _getLawManagerList(page = 1) {
       const param = { page, size: this.pagination.pageSize, source_type: 4 }
