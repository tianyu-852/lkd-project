<template>
  <a-layout class="main">
    <a-layout-header class="top">
      <span class="focus-text">律师管家总数：{{ pagination.total }}</span>

      <a-button type="primary" style="margin: 0 10px" @click="openAddLawManagerModal">新增法律管家</a-button>
    </a-layout-header>
    ...
    <a-card class="content">
      ...
      >
        ...
        <!-- 法务类型 -->
        <a-table-column dataIndex="source_type_chinese" title="法务类型" align="center" />
...
export default {
  ...
  data() {
    return {
      ...
      lawManagerSelectList: [{ label: '律师管家', value: 0 } ], // 法务管家 select
  ...
  methods: {
     ...
     */
     async _getLawManagerList(page = 1) {
       const param = { page, size: this.pagination.pageSize, source_type: 0 }
