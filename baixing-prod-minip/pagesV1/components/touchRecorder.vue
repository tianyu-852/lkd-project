		...
		<u-mask :show="isRecorder" v-if="isRecorder">
			<view class="maskBox">
				<view class="recorderIng flex flexcenter hcenter" v-if="isRecorder === 1">
					<image src="/pagesV1/static/images/bg_voice.gif" mode="widthFix"></image>
					<image class="triangle" src="/pagesV1/static/images/j_icon.svg" mode="widthFix"></image>
				</view>
				...
				<image v-if="isRecorder === 2" class="recorderDel" src="/pagesV1/static/images/bg_recorder_cancel.gif" mode="scaleToFill"></image>
				<text v-if="isRecorder === 1" class="sendHint">松开 发送</text>
				<image v-if="isRecorder === 1"  class="bottom" src="/pagesV1/static/images/bg_recorder_normal.png" mode="widthFix"></image>
				<image v-if="isRecorder === 2" class="bottom" src="/pagesV1/static/images/bg_recorder_cancel.png" mode="widthFix"></image>
