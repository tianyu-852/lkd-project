...
* CodeVersion: 163a9d950daea96bd8737898d59650b2720a3eb6
* Release Date: Tue Nov 24 2020 16:32:10 GMT+0800 (GMT+08:00)
...
(function (global, factory) {
  ...
  var _setInterval = setInterval.bind(null);

  var _setTimeout = setTimeout.bind(null);

  var _clearTimeout = clearTimeout.bind(null);

  var _clearInterval = clearInterval.bind(null);
  ...
  var Codec$2 = function () {
    ...
    _proto.encodeModifyChatRoomKV = function encodeModifyChatRoomKV(chrm, entry, action, currentUserId) {
      ...
      if (isSendNotification) {
        ...
        this.connectType === CONNECT_TYPE.COMET ? modules.setNotification(msgModule.data) : modules.setNotification(msgModule);
