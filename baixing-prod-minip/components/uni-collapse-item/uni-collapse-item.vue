		...
		<view class="uni-collapse-cell__title" @click="onClick">
			...
			<view :class="{ 'uni-collapse-cell__title-arrow-active': isOpen, 'uni-collapse-cell--animation': showAnimation === true }"
			 class="uni-collapse-cell__title-arrow">
				<u-icon color="#bbb" size="20" name="arrow-down" />
			</view>
			<!-- #endif -->
			<!-- #ifndef MP-ALIPAY -->
			<u-icon :class="{ 'uni-collapse-cell__title-arrow-active': isOpen, 'uni-collapse-cell--animation': showAnimation === true }"
			 class="uni-collapse-cell__title-arrow" color="#bbb" size="20" name="arrow-down" />
			<!-- #endif -->
		</view>
		<view v-if="isOpen" style="margin: 0 24rpx;border-top: 1rpx solid #DCE4EF;">
